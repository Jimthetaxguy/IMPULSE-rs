...
pub struct SearchMatch {
    ...
    // dead_code: retained for future inline result previews and tests, even though the current UI only jumps by tab/line.
    #[allow(dead_code)]
    pub line: String,
...
impl TerminalSearch {
    ...
    /// Total match count.
    // dead_code: reserved for status-bar/search-summary surfaces and covered by unit tests.
    #[allow(dead_code)]
