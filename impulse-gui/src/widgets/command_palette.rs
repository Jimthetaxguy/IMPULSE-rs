...
#[allow(dead_code)] // dead_code: legacy focus commands remain in the enum until the last app routing arms are removed.
pub enum Command {
    NewTab,
    CloseTab,
    CycleTabs,
...
impl CommandPalette {
    ...
    #[allow(dead_code)] // dead_code: open-state probing is reserved for future shell-wide palette routing.
