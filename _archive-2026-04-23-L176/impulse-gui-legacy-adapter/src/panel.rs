...
use eframe::egui;
use impulse_term::context::{
    self, AgentKind, ContextBridge, ContextHealth, ContextTier, ExtractedInsight, InsightType,
};
                             ...
                             insights: &[&ExtractedInsight]| {
                                ...
                                .show(ui, |ui| {
                                    for insight in insights.iter().rev() {
                                        ...
                                        ui.label(format!(
                                            "  {} ({}m ago)",
                                            context::truncate_insight(&insight.content, 60),
                                            elapsed
                                        ));
                                    }
                                });
...
mod tests {
    ...
    fn test_truncate_insight_reuse() {
        use impulse_term::context::truncate_insight;
