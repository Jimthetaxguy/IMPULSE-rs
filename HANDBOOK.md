...
| **Tests**                            | 1,693 passing (4 ignored) | `impulse-rs/src/*/tests.rs` |
...
| Tests passing (`cargo test`) | 1,693 (1363+26 impulse-rs + 31 ops + 114 term + 159 desktop, 4 ignored; impulse-gui frozen/excluded) |
...
| **Now**    | Tests (1,693 passing)                                                  | Rust        | **Complete** |
