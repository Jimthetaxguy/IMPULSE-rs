...
| Dioxus cockpit hierarchy | Progressive project setup, window-lifetime project binding, project-scoped workers/tasks, focused assignment/evidence, and collapsed secondary launch are covered by SSR contracts | Use this active surface as the acceptance replacement; do not preserve the legacy egui information architecture |
