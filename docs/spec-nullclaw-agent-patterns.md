...
> **Source:** `nullclaw-deep-analysis.md` (local research note, not checked into this repo)
...
- **NullClaw Analysis:** `nullclaw-deep-analysis.md` (local research note, not checked into this repo)
