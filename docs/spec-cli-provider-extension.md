...
> **Date:** 2026-03-02
> **Status:** Draft
> **Companion:** `~/.ai-memory/docs/spec-cli-provider-abstraction.md` (cross-platform companion spec, not checked into this repo)
...
- **Companion (cross-cutting):** `~/.ai-memory/docs/spec-cli-provider-abstraction.md` (cross-platform companion spec, not checked into this repo)
