...
> **Date:** 2026-03-02
> **Status:** Draft
> **Companion:** `~/.ai-memory/docs/spec-os-sandbox-framework.md` (cross-platform companion spec, not checked into this repo)
...
- **Companion (cross-cutting):** `~/.ai-memory/docs/spec-os-sandbox-framework.md` (cross-platform companion spec, not checked into this repo)
